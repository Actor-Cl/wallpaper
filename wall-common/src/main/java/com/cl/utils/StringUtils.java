...
/**
 * 字符串工具类，继承了org.apache.commons.lang3.StringUtils类
 *
 * @author chenglei
 * @data 2021年05月2021/5/26日 11:44
 */
public class StringUtils extends org.apache.commons.lang3.StringUtils{
    ...
    public static String getHttpCityInfo(String ip) {
        String api = String.format(WallConstant.Url.IP_URL, ip);
    ...
    public static String getLocalCityInfo(String ip) {
        try {
            ...
            return address.equals(WallConstant.REGION) ? "内网IP" : address;
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
        return "";
